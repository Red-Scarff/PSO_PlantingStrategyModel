...
# Step 1: 读取数据
file_path1 = "相关性信息_类别1.xlsx"
file_path2 = "相关性信息_类别2.xlsx"
file_path3 = "相关性信息_类别3.xlsx"
...
crop_cluster_group = crop_supplement["聚类种类"].tolist()  # 作物聚类后的类别
...
expected_demand = crop_supplement["预期销售量/斤"].tolist()  # 预期销售量
        ...
        for row in range(num_rows):
            ...
            if field_name == "类别1":
                predict_sales = predict_sale(
                    cost_new, price_new, coefficients_1, intercept_2
                )
                if predict_sales < 0:
                    predict_sales = 0
            elif field_name == "类别2":
                predict_sales = predict_sale(
                    cost_new, price_new, coefficients_2, intercept_2
                )
                if predict_sales < 0:
                    predict_sales = 0
            elif field_name == "类别3":
